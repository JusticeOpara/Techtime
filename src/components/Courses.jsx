    ...
    return (
        <div className="courses-section" id="Courses">
            ...
            <div className="courses-subheader">
                <p className="active-courses">All categories</p>
                <p className="active-courses">Design</p>
                <p className="active-courses">Development</p>
                <p className="active-courses">Marketing</p>
            </div>
